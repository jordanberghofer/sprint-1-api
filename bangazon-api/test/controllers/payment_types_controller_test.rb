...
class PaymentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_type" do
    assert_difference('PaymentType.count') do
      post payment_types_url, params: { payment_type: { credit_card_number: @payment_type.credit_card_number, customer_id: @payment_type.customer_id, payment_type_name: @payment_type.payment_type_name } }, as: :json
    end
  ...
  test "should update payment_type" do
    patch payment_type_url(@payment_type), params: { payment_type: { credit_card_number: @payment_type.credit_card_number, customer_id: @payment_type.customer_id, payment_type_name: @payment_type.payment_type_name } }, as: :json
    assert_response 200
  end
