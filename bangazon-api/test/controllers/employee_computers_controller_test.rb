...
class EmployeeComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employee_computer" do
    assert_difference('EmployeeComputer.count') do
      post employee_computers_url, params: { employee_computer: { computer_id: @employee_computer.computer_id, employee_id: @employee_computer.employee_id, end: @employee_computer.end, start: @employee_computer.start } }, as: :json
    end
  ...
  test "should update employee_computer" do
    patch employee_computer_url(@employee_computer), params: { employee_computer: { computer_id: @employee_computer.computer_id, employee_id: @employee_computer.employee_id, end: @employee_computer.end, start: @employee_computer.start } }, as: :json
    assert_response 200
  end
